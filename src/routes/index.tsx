  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 relative">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center md:text-right order-2 md:order-1 animate-fade-in">
              ...
              <h1 className="font-heading text-4xl sm:text-5xl md:text-7xl font-black text-primary-foreground text-shadow-soft leading-tight">
                دار الكرم
              </h1>
              <p className="text-xl sm:text-2xl md:text-3xl text-primary-foreground/80 mt-2 sm:mt-3 font-heading font-light">
                للنشر والتوزيع والترجمة
              </p>
              <p className="text-primary-foreground/60 mt-4 sm:mt-6 text-base sm:text-lg max-w-lg leading-relaxed mx-auto md:mx-0">
                نفتح لك أبواب المعرفة من خلال مجموعة متنوعة من أفضل الكتب العربية والمترجمة
              </p>
              <div className="flex flex-wrap gap-3 sm:gap-4 mt-8 sm:mt-10 justify-center md:justify-start">
                <Link to="/books">
            ...
            <div className="flex-shrink-0 order-1 md:order-2 animate-scale-in">
              <div className="relative">
                ...
                <img src={logo} alt="دار الكرم" className="relative w-36 h-36 sm:w-52 sm:h-52 md:w-72 md:h-72 rounded-full shadow-2xl border-4 border-primary-foreground/20" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-card border-b border-border relative -mt-6 sm:-mt-8 z-10 mx-4 sm:mx-8 lg:mx-auto max-w-5xl rounded-2xl shadow-xl">
        <div className="px-4 py-8 sm:py-10 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
          {[
            ...
            <div key={i} className="flex flex-col items-center gap-1.5 sm:gap-2 group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8 sm:mb-10">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">اختيارات مميزة من دار الكرم</p>
            </div>
            <Link to="/books" className="text-primary text-sm font-medium hover:underline inline-flex items-center gap-1">
              عرض الكل
      ...
      <section className="py-10 sm:py-16 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-2xl sm:text-3xl font-bold text-foreground mb-2 text-center">📚 التصنيفات</h2>
          <p className="text-muted-foreground text-sm text-center mb-8">اكتشف الكتب حسب اهتماماتك</p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
            {categories.filter(c => c.slug !== "best-sellers").map((cat, i) => (
              <Link
                ...
                className="bg-card rounded-xl p-4 sm:p-5 text-center card-hover border border-border group animate-fade-in"
                style={{ animationDelay: `${i * 50}ms`, animationFillMode: 'both' }}
              >
                <span className="text-3xl sm:text-4xl block mb-2 sm:mb-3 group-hover:scale-110 transition-transform inline-block">{cat.icon}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8 sm:mb-10">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">الكتب الأكثر طلبًا من قرائنا</p>
            </div>
            <Link to="/books" search={{ category: "best-sellers" }} className="text-primary text-sm font-medium hover:underline inline-flex items-center gap-1">
              عرض الكل
              <ArrowLeft className="h-3.5 w-3.5" />
            </Link>
          </div>
      ...
      <section className="py-12 sm:py-20 hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative">
          ...
          <p className="text-primary-foreground/70 text-base sm:text-lg mb-8 max-w-xl mx-auto leading-relaxed">
      ...
      <section className="py-10 sm:py-16 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-2xl sm:text-3xl font-bold text-foreground mb-2 text-center">💬 آراء القراء</h2>
          <p className="text-muted-foreground text-sm text-center mb-8">ماذا يقول قراؤنا عنّا</p>
