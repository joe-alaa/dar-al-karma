  ...
  notFoundComponent: () => (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        ...
        <Link to="/books" search={{ category: undefined }} className="text-primary mt-4 inline-block">العودة للكتب</Link>
      </div>
    </div>
  ),
});
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Link to="/books" search={{ category: undefined }} className="inline-flex items-center gap-2 text-primary text-sm font-medium hover:underline mb-6">
