...
export const categories: Category[] = [
  ...
  { slug: "self-help", name: "تنمية ذاتية", icon: "🌱" },
  { slug: "horror", name: "رعب", icon: "👻" },
  { slug: "mystery", name: "غموض", icon: "🕵️" },
...
export const books: Book[] = [
  {
    ...
    category: "جريمة",
    categorySlug: "crime",
    additionalCategories: ["sci-fi", "action"],
    isBestSeller: true,
    isFeatured: true,
    rating: 4.7,
    pages: 150,
  ...
  },
  {
    ...
    category: "أكشن",
    categorySlug: "action",
    additionalCategories: ["sci-fi", "drama"],
    isBestSeller: true,
    rating: 4.5,
    pages: 141,
    year: 2025,
